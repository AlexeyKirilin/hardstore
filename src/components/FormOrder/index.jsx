                            ...
                            <label className={styles.label}>
                                <div className={styles.wrapper}>
                                    <input 
                                        ...
                                        name="radio"/>
                                    <div className={styles.city}>
                                        Г.Ульяновск, ул. Льва Толстого, д 7.
                                    </div>
                                </div>
                            ...
                            <label className={styles.label}>
                                <div className={styles.wrapper}>
                                    <input 
                                        ...
                                        name="radio"/>
                                    <div className={styles.city}>
                                        Г.Ульяновск, ул. Карла Маркса, д 35.
                                    </div>
                                </div>
                                    <p className={styles.time}>10:00 – 19:00, без выходных</p>
                            </label>
                    ...
                    <div>
                        ...
                        <div className={styles.cardWrapper}>
                            ...
                            <div className={styles.innerError}>
                                ...
                                {formik.errors.cardNumber && formik.touched.cardNumber ? <div className={styles.error}>{formik.errors.cardNumber}</div> : null}
                            </div>
                        </div>
                        <div className={styles.cardInner}>
                            <div className={styles.selectError}>
                                ...
                                {formik.errors.month && formik.touched.month ? <div className={styles.error}>{formik.errors.month}</div> : null}
                            </div>
                            <div className={styles.selectError}>
                                <select 
                                    name="year"
                                ...
                                {formik.errors.year && formik.touched.year ? <div className={styles.error}>{formik.errors.year}</div> : null}
                            </div>
                                <input 
                                    ...
                                    name="cvv"
                                    placeholder='CVV' />
                                {formik.errors.cvv && formik.touched.cvv ? <div className={styles.error}>{formik.errors.cvv}</div> : null}
                        </div>
